...
- [ ] 归档保留 Thread 身份、标题、历史、附件、未发送 composer state、运行配置、Runtime Session、置顶和 Thread Activity Time。
...
- [ ] 永久删除原子清理全部 Carrent-owned Thread 数据、附件快照、未发送状态、队列、Run Checklist 和 Runtime Session 映射。
