/**
 * Chart math ported from t3code `UsageProviderChart.tsx` for the settings
 * Usage panel. Pure functions only; the panel composes its own layout.
 */
 ...
 */
export function monotoneTangents(points: readonly Point[]): readonly number[] {
...
export function curvePath(segments: readonly CurveSegment[], startCommand: "M" | "L"): string {
