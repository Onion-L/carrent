          ...
          <div className="space-y-0.5">
            {projects.map((project) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex min-h-9 items-center gap-2 rounded-lg px-2 py-1.5 transition ${
                      isActive
                  ...
                  >
                    {editingProjectId === project.id && !collapsed ? (
                      ...
                      >
                        {collapsed ? (
                          <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-surface-raised text-[12px] font-semibold text-muted">
